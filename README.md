...
- 完整行前清单：包含证件、交通与充电、儿童照护、个护洗漱、妈妈化妆品、爸爸剃须刀、袜子/内衣/随身衣物和脏衣袋等易漏物品。
- 分阶段携带清单：按酒店出门、离车入园、午休返场、非迪士尼拍摄和返程节点，分别列出路线、必带、可选与留存检查；早餐后退房会展开全部行李与房间扫尾项。
...
│   ├── departure_checklist_template.md # 🎒 分阶段离店/离车携带清单模板
